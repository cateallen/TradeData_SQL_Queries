...
SELECT * 
INTO [DOC_C2S_2010_2017_AW_CW_VW.V12]
...
/****** Object:  Table [dbo].[DOC_C2S_2010_2017_AV_CV_VV.V2]    Script Date: 3/28/2019 4:05:30 PM ******/
...
SELECT 	[Mode]
	...
	,[W2017]
	,NULL
FROM [dbo].[DOC_C2S_2010_2017_AW_CW_VW.V12]
...
SELECT [Mode]
	...
	,NULL
	,NULL
FROM [Tradecube 3.0 Processed Files].[dbo].[ DOC_C2S_-HS6_US_2018_UNPIV_Value]
...
SELECT [Mode]
	...
	,NULL
	,[W2018]
  FROM [Tradecube 3.0 Processed Files].[dbo].[ DOC_C2S_-HS6_US_2018_UNPIV_Weight]
